...
struct BrushGpencilSettings	{
	...
	float	outline_fac;
	float	simplify_px;
	float	conversion_threshold;
	int8_t	curve_type;
	char	_pad4[3];
	float	fill_gap_factor;
	char	_pad5[4];
	Material	*material;
...
struct Brush	{
	...
	MeshAutomaskingSettings	*mesh_automasking_settings;
};
...
struct MaterialGPencilStyle	{
	...
	int	placement_mode;
	int	placement_count;
	float	placement_radius_spacing;
	float	placement_density;
	float	random_size_factor;
	float	random_strength_factor;
	float	random_rotation_factor;
	float	random_hue_factor;
	float	random_saturation_factor;
	float	random_value_factor;
...
struct MeshDeformModifierData	{
	...
	void	*bindinfluences_sharing_info;
	int	*bindoffsets;
	void	*bindoffsets_sharing_info;
	float	*bindcagecos;
	void	*bindcagecos_sharing_info;
	int	totvert;
	int	totcagevert;
	MDefCell	*dyngrid;
	void	*dyngrid_sharing_info;
	MDefInfluence	*dyninfluences;
	void	*dyninfluences_sharing_info;
	int	*dynverts;
	void	*dynverts_sharing_info;
	int	dyngridsize;
	int	totinfluence;
	float	dyncellmin[3];
	float	dyncellwidth;
...
struct bNodeTreeInterfaceSocket	{
	...
	char	is_pixel_socket_forward_compat;
	char	_pad[6];
};
...
struct bNodeTree	{
	...
	CompositorNodeAssetTraits	*compositor_node_asset_traits;
	PreviewImage	*preview;
	void	*runtime;
};
...
struct NodeShaderRaycast	{
	int	_pad0;
	int	next_identifier;
	NodeRaycastSampleAttributeItem	*sample_attribute_items;
	int	sample_attribute_items_num;
	int	active_index;
};
...
struct Object	{
	...
	Object	*parent;
	Object	*track;
	float	parent_bone_head_tail_factor;
	char	_pad4[4];
	Object	*proxy;
	Object	*proxy_group;
	Object	*proxy_from;
...
struct MeshAutomaskingSettings	{
	int	flags;
	int	boundary_edges_propagation_steps;
...
struct uiTextboxStateLink	{
	uiTextboxStateLink	*next;
	uiTextboxStateLink	*prev;
	char	*idname;
	TextboxState	state;
};
...
struct ThemeSpace	{
	...
	char	anim_interpolation_linear[4];
	char	anim_interpolation_constant[4];
	char	anim_interpolation_other[4];
	char	keyborder[4];
...
struct UserDef_Experimental	{
	...
	char	use_remote_asset_libraries;
	char	use_collection_importer;
	char	_pad[4];
};
