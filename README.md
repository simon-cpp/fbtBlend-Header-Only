...
## Blender versions from 2.80 to 5.2 LTS

In the *280*, *...*, *502_LTS* repository folders there are versions of **fbtBlend.h** and **Blender.h** updated for Blender 2.80, ..., 5.2 LTS.
In the *280/tests*, *.../tests*, *502_LTS/tests* subfolders there are some test programs that should compile correctly with these versions.
